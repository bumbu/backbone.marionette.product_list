...
require(['backbone', 'marionette', 'collections/Products', 'models/Totals', 'views/FormView', 'views/ProductsView', 'views/TotalsView'], function(Backbone, Marionette, Products, Totals, FormView, ProductsView, TotalsView) {
  "use strict";
  var ProductTracker;
